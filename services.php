        ...
        <div class="col-xl-11 col-lg-12">
            ...
            <div class="bloc part" id="pac">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h4>Les Avantages</h4>
                        <ul>
                            <li>Coût moindre en comparaison aux autres systèmes de chauffage</li>
                            <li>Nécessite moins d’entretien </li>
                            <li>Plus sûr que d’autres systèmes à combustion</li>
                            <li>Subventions gouvernementales </li>
                            <li>Réduit l’empreinte carbone</li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <h4>Les Bénéfices</h4>
                        <p>
                            L’installation pompe à chaleur est un véritable gain en confort pour ses utilisateurs.
                            En effet, ce seul dispositif permet le fonctionnement de plusieurs appareils. Le client
                            aura donc moins de système à gérer grâce à l’installation d’une PAC, en plus de réaliser
                            des économies.
                        </p>
                    </div>
                </div>
            ...
            <div class="bloc part" id="ite">
                <div  class="row serv">
                    ...
                    <div class="col text">
                        <h2>ITE / ITI</h2>
                        <p>Une isolation thermique par l’intérieur (ITI) consolide et isole les murs de vos pièces
                            des
                            déperditions de chaleur. L’isolation thermique par l’extérieur (ITE) concerne les parois
                            de
                            votre façade. </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <h4>ITE</h4>
                            <ul>
                                <li>Jusqu’à 30 % d’économies sur votre consommation totale d’énergie</li>
                                <li>Ne grignote pas de surface intérieure </li>
                                <li>Opération deux-en-un d’isolation et de ravalement</li>
                                <li>Vous améliorez l’aspect global de votre maison et conservez votre intérieur tel
                                    quel
                                </li>
                                <li>Vous pouvez rester chez vous pendant toute la durée des travaux</li>
                                <li>Réduction considérable des déperditions et ponts thermiques</li>
                                <li>Vous valorisez votre bien et sa rentabilité jusqu’à moyen long terme</li>
                                <li>Implique de plus gros travaux et nécessite l’intervention d’un professionnel du
                                    bâtiment</li>
                            </ul>
                        </div>
                        <div class="col-md-5">
                            <h4>ITI</h4>
                            <ul>
                                <li>Processus simple</li>
                                <li>Solution qui s’adapte à des problématiques particulières comme l’isolation du
                                    sol
                                </li>
                                <li>Préservation de vos façades</li>
                                <li>Vous pouvez mettre à profit vos travaux en rénovant votre intérieur</li>
                                <li>Ne grignote pas de surface intérieure</li>
                                <li>Moins coûteux</li>
                            </ul>
                        </div>
            ...
            <div class="bloc part" id="vmc">
                <div class="row serv">
                    ...
                    <div class="col text">
                        <h2>VMC</h2>
                        <p>La ventilation mécanique contrôlée (VMC) est un équipement essentiel qui permet de
                            renouveler
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h4>Les Avantages</h4>
                            <ul>
                                <li>Supprimer les déperditions thermiques inhérentes à la ventilation</li>
                                <li>Renouvellement automatique</li>
                                <li>Gage de confort</li>
                                <li>Garantie d’une qualité d’air optimale</li>
                                <li>Alléger le niveau d'humidité</li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            <h4>Les Bénéfices</h4>
                            <p>
                                Une VMC est le moyen le plus sûr de garantir un renouvellement de l’air à moindre
                                coût.
                                Elle est un indispensable pour le bien-être et la santé des occupants.
                            </p>
                        </div>
            ...
            <div class="bloc part" id="tce">
                ...
                <div  class="row ">
                    ...
                    <div class="col-md-6 text">
                        ...
                        <p>
                            Un large champs d'expertise sur tous types de batiments et pour tous types
                            d'interventions
                            allié
                ...
                <div class="row serv">
                    ...
                    <div class="col text">
                        ...
                        <p>La rénovation énergétique consiste à réaliser des travaux sur un bâtiment existant afin
                            d’améliorer sa performance énergétique. Elle se définit par le rapport entre le niveau
                            d'énergie
                            absorbé par le bâtiment et l'énergie totale qu'il consomme réellement pour son
                            fonctionnement.
                        </p>
