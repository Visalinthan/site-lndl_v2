                                ...
                                <div class="slider-item">
                                    <div class="slider-left">
                                        <div class="slider-left-content">
                                            <h3>One of the best consulting agency</h3>
                                            <h2>Business Solutions For
                                                All Enterprises</h2>
                                            <p>Maecenas posuere neque et volutpat accumsan. Aliquam hendrerit
                                                tincidunt diam eu imperdiet. Etiam dictum suscipit tempus.
                                                Vestibulum eget pellentesque dolor. Duis enim risus, malesuada
                                                sodales sapien eu, commodo malesuada tortor.</p>
                                ...
                                <div class="swiper-slide">
                                    <div class="features-box wow fadeInUp" data-wow-delay="0ms"
                                        ...
                                        <div class="features-box-inner">
                                            ...
                                            <h3 class="headline">HR Consultancy</h3>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="features-box active wow fadeInUp" data-wow-delay="300ms"
                                        ...
                                        <div class="features-box-inner">
                                            ...
                                            <h3 class="headline">Digital Products</h3>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="features-box wow fadeInUp" data-wow-delay="600ms"
                                        ...
                                        <div class="features-box-inner">
                                            ...
                                            <h3 class="headline">Business Strategy</h3>
                                        </div>
                                        <div class="box-content">
                                            <div class="content-post">
        ...
        <section class="tf-space flat-about">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="about-left-content wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="section-title">
                                <h3 class="section-heading">About Consalti</h3>
                                    ...
                                    <div class="text-wrap clearfix">
                                        ...
                                        <fieldset class="email-wrap">
                                            <select class="input-contact input-select valid" name="services"
                                                ...
                                                <option value="1">Consalti</option>
                                                <option value="2">Consalti</option>
                                                <option value="3">Consalti</option>
                                            </select>
                                        </fieldset>
                                    </div>
        ...
        <section class="tf-space flat-our-ex">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="themesflat-spacer clearfix" data-desktop="51" data-mobile="30" data-smobile="30">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="our-ex-box">
                            <figure class="image"><img src="assets/images/image-box/our-ex-post-1@2x.jpg" alt="images">
                            </figure>
                    ...
                    <div class="col-md-4">
                        <div class="our-ex-box">
                            <figure class="image"><img src="assets/images/image-box/our-ex-post-2@2x.jpg" alt="images">
                            </figure>
                            <div class="overlay-box"></div>
                            <a href="portfolio.html" class="button readmore">View All Projects</a>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="our-ex-box">
                            <figure class="image"><img src="assets/images/image-box/our-ex-post-3@2x.jpg" alt="images">
                            </figure>
                            <div class="overlay-box"></div>
                            <a href="portfolio.html" class="button readmore">View All Projects</a>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="our-ex-box">
                            <figure class="image"><img src="assets/images/image-box/our-ex-post-4@2x.jpg" alt="images">
                            </figure>
                            <div class="overlay-box"></div>
                            <a href="portfolio.html" class="button readmore">View All Projects</a>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="our-ex-box">
                            <figure class="image"><img src="assets/images/image-box/our-ex-post-5@2x.jpg" alt="images">
                            </figure>
                            <div class="overlay-box"></div>
                            <a href="portfolio.html" class="button readmore">View All Projects</a>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="about-left-content wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                            ...
                            <div class="progress-about wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <div class="couter">
                                    <div class="chart" data-percent="85">
                                        <span class="percent">0</span>
                                    </div>
                            ...
                            <div class="progress-about wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                                <div class="couter">
                                    <div class="chart" data-percent="75">
                                        <span class="percent">0</span>
                                    </div>
                        ...
                        <div class="subcribe-content wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                            ...
                            <div class="widget-subcribe">
                                <form action="#" method="get" class="subcribe-form">
                                    <input type="email" class="subcribe-form-footer" placeholder="Your email address"
