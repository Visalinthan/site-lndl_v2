                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4">
                        <div class="latest-content-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                            ...
                            <div class="latest-content link-style-2">
                                <h5>Tout savoir sur la VMC</h5>
                                <div class="latest-content-bottom">
                                    <div class="post-readmore">
                                        <a href="https://lndlblog.fr/Eh36822/tout-savoir-sur-la-vmc/" class="read-more" target="_blank"><span class="text">Lire
                                                l'article</span></a>
                                    </div>
                                    <span class="post-tag">VMC</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="latest-content-box wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                            ...
                            <div class="latest-content link-style-2">
                                <h5>In this context our main
                                    approach was to build</h5>
                                <div class="latest-content-bottom">
                                    <div class="post-readmore">
                                        <a href="blog-details.html" class="read-more" target="_blank"><span class="text">Lire
                                                l'article</span></a>
                                    </div>
