...
<head>
    <meta charset="utf-8">
    <title>La Nationale Du Logement</title>
...
<body>
    ...
    <main id="home" class="container row">
        <div id="sous-menu" class="col-xl-1 col-lg-12">
            <ul>
                <li><a href="#story">Accueil</a></li>
                <li><a href="#team">Nous choisir</a></li>
                <li><a href="#process">Nos Expertises</a></li>
                <li><a href="#engagement">Nos Certifications</a></li>
            </ul>
        </div>
        <div class="col-xl-11 col-lg-12">
            <div class="bloc" style="position: relative;">
                ...
                <div class="bloc-left-down">
                    <div class="triangle"
                        style="border-width: 800px 0 0 500px; border-color: transparent transparent transparent #fff;">
